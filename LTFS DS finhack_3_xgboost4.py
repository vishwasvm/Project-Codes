...
@author: Vishwas
"""
#### LTFS DS finhack_3 competition on loan top up prediction problem ####
...
df=pd.read_csv('V:LTFS Data Science FinHack 3/Data_csv/Train/train_Data.csv') # After preprocessing and EDA
df.info()
